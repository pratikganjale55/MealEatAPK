      ...
      <ScrollView>
        <View style={styles.DetailsContainer}>
          <View style={styles.detailsTopView}>
            ...
            <View style={{flex: 1}}>
              <Text style={styles.mealTitle}>
                {toggleValue ? t(subData.title) : subData.title}
              </Text>
              <Text style={{color: '#999999'}}>
                {toggleValue ? t(subData.subtitle) : subData.subtitle}
              </Text>
              <Text style={{color: '#999999'}}>
          ...
          <View>
            ...
            <View style={styles.row}>
              <Text>
                {toggleValue ? t('Delivery Time') : 'Delivery Time :'}
              </Text>
              <TouchableOpacity
                ...
                <Text style={styles.timeButtonText}>
                  {toggleValue ? t('Lunch') : 'Lunch'}(12-2)
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                <Text style={styles.timeButtonText}>
                  {toggleValue ? t('Dinner') : 'Dinner'} (7-9)
                </Text>
              </TouchableOpacity>
            </View>
            <View style={styles.row}>
          ...
          <Button
            ...
            disabled={selectedDate === null || selectedDays.length == 0}
          />
        </View>
      </ScrollView>
    </>
